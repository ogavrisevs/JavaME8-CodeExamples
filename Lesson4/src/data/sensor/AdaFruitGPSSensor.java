...
public abstract class AdaFruitGPSSensor implements GPSSensor, Messages {
     ...
     * sub-class dependent.
     *
     * @param type The type of data to be retieved
    ...
    public String getRawData(String type) throws IOException {
        ...
        do {
            /**
             * Retrieve a line with the appropriate tag. Return null in the case
             * of an error
             */
            try {
    ...
    public Position getPosition() throws IOException {
        ...
        while (true) {
            ...
            /**
             * The position data must have 10 fields to it to be valid, so
             * reject the data if we don't have the correct number
             */
            if (fieldCount < 10) {
            ...
            /**
             * Parse the relevant fields into values that we can use to create a
             * new Position object.
             */
            try {
                ...
                printMessage("Badly formatted latitude number, using 0,N", ERROR);
                latitude = 0.0;
                latitudeDirection = 'N';
            }
            ...
            try {
                ...
                printMessage("Badly formatted longitude number, using 0,W", ERROR);
                longitude = 0.0;
            ...
            try {
                ...
                printMessage("Badly formatted altitude number, using 0", ERROR);
                altitude = 0.0;
            }
    ...
    public Velocity getVelocity() throws IOException {
        ...
        while (true) {
            ...
            if (fieldCount < 8) {
                ...
                printMessage("rawData : "+ rawData, INFO);
                
                try {
                    Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(AdaFruitGPSSensor.class.getName()).log(Level.SEVERE, null, ex);
                }
                continue;
            }
